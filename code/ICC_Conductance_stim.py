...
def deterministic(intensity="moderate", conductance=35):
    
    print("Begin.")
    controlStim = ExtracellStim("Control")
    sine05Stim = ExtracellStim("Sine",0.5)
    sine5Stim = ExtracellStim("Sine",5)    
    sine50Stim = ExtracellStim("Sine",50, dur=100)
    pulse05Stim = ExtracellStim("Pulse",0.5)
    pulse14Stim = ExtracellStim("Pulse",14)
    print("Imported all stimulation waveforms.")
    print('\n')

    control = MotilityModel_CES(controlStim, conductance, intensity) 
    pulse05 = MotilityModel_CES(pulse05Stim, conductance, intensity)  
    pulse14 = MotilityModel_CES(pulse14Stim, conductance, intensity)
...
if __name__ == "__main__":
    # sineStim = ExtracellStim("Sine")
    # conductance = 25
    # control = MotilityModel_CES(sineStim,conductance)
    
    deterministic("moderate", conductance=25)
